...
<body class="bg-gray-100 font-sans antialiased text-gray-800">
    ...
    <div class="min-h-screen flex flex-col">
        <main class="flex-1 p-6 overflow-y-auto">
            ...
            <div class="mb-6">
                <a href="{{ route('admin.incidencias') }}" class="flex items-center gap-2 px-4 py-1.5 border border-gray-400 rounded bg-white hover:bg-gray-50 text-sm font-medium shadow-sm transition w-fit">
                        ...
                        <table class="w-full text-left text-sm border-collapse">
                            <thead class="bg-gray-100 text-gray-700 border-b border-gray-300 font-bold uppercase text-[11px] tracking-wider">
                                <tr>
                                    ...
                                    <th class="p-3 border-r border-gray-300 text-center">Ubicación</th>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-blue-50/30 transition border-b border-gray-300 last:border-0">
                                    ...
                                    <td class="p-3 border-r border-gray-300 text-center">
                                        <button onclick="alert('Abriendo mapa de incidencia #{{$id}}')" 
                                                class="bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded text-xs font-bold transition shadow-sm uppercase tracking-tighter inline-flex items-center gap-1">
                                    ...
                                    <td class="p-3 text-center">
                                        <button onclick="openModal('Incidencia #{{$id}}', 'Esta es la descripción detallada de la incidencia número {{$id}}.')" 

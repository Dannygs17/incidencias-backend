    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md border-t-4 border-blue-500 relative text-center hover:shadow-lg dark:hover:bg-gray-750 transition cursor-pointer group">
                ...
                <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md border-t-4 border-yellow-400 relative text-center hover:shadow-lg dark:hover:bg-gray-750 transition cursor-pointer group">
                ...
                <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md border-t-4 border-gray-500 relative text-center hover:shadow-lg dark:hover:bg-gray-750 transition cursor-pointer group">
                ...
                <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md border-t-4 border-green-500 relative text-center hover:shadow-lg dark:hover:bg-gray-750 transition cursor-pointer group">
                ...
                <div class="bg-gray-50 dark:bg-gray-700 p-8 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600 flex flex-col items-center justify-center text-gray-400 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-600 transition cursor-pointer">
